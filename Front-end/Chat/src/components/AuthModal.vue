        ...
        <a-modal class="modal" v-model:visible="visible" :title="title" @ok.prevent="handleOk">
            ...
            <div v-if="!loading" class="input-container">
                <a-form :model="userCredentials">
                    <a-row v-if="!isLogin">
                        <a-col :span="24">
                            <a-form-item label="Họ và tên" :label-col="{ span: 5 }" name="full_name"
                                :rules="[{ required: true, message: 'Hãy nhập họ và tên!' }]">
                                <a-input v-model:value="userCredentials.full_name">
                                    <template #prefix>
                    ...
                    <a-row>
                        <a-col :span="24">
                            <a-form-item label="Username" :label-col="{ span: 5 }" name="username"
